        ...
        <div class="info_bttn_cont">
            <div>
                    ...
                    <div class="info_cont2">
                        ...
                        <?php
                            echo '
                                ...
                                <p class="show_prdct_stock">'. htmlspecialchars($crrnt_prdct['ilan']) .'</p>
                                <p class="show_prdct_prc"><span class="php_txt">php </span>'. htmlspecialchars($crrnt_prdct['prc']) .'</p>
                ...
                <div class="dskrpsyn_bttn_cont">
                    ...
                    <button class="edit_prdct_bttn">I-edit ang produkto</button>   
                </div>
            </div>
        </div>
    </div>
